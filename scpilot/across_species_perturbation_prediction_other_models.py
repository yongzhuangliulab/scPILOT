...
parser = argparse.ArgumentParser(description='across_species_perturbation_prediction_other_models')
parser.add_argument(
    '--model_name',
    type=str,
    default='biolord',
...
def add_fixed_biolord_split_column(
    ...
    Held-out stimulated cells of the query species are assigned to 'test' and are
