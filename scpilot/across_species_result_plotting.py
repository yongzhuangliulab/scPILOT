...
def paired_test_scpilot_vs_baseline(query_summary, metric, baseline, test_name):
    ...
    Each paired sample is one held-out species.
    The value for each held-out species is the average across three seeds.
    """
...
def plot_splitwise_radar_chart(
    ...
    for i, model_name in enumerate(model_order):
        ...
        if sd_col in dfg_mean.columns:
            ...
            # Optional error bars showing mean ± SD at each held-out species.
            if show_error_bars:
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Across-species result plotting and summary.')
