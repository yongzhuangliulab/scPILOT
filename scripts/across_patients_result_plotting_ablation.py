...
def summarize_recovery_gene_level(
    ...
    # Paired two-sided Wilcoxon on eight query-level seed averages.
    wilcoxon_records = []
    variants = [
        model_name
        for model_name in model_names
...
def paired_test_reference_vs_variant(
    ...
    Each paired observation is one held-out patient.
    Values are first averaged across model seeds within each patient.
    """
...
def summarize_worst_case_performance(
    ...
    """
    Summarize worst-case performance across held-out patients.
...
def plot_aggregate_boxplot_combined(
    ...
    Each box summarizes split-level mean values across held-out patients.
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description='Across-patient ablation result plotting and summary.'
    )
