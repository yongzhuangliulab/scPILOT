...
parser = argparse.ArgumentParser(description='across_patients_perturbation_prediction_w_o_adaptive_weighting')
parser.add_argument(
    '--query_key',
    type=int,
    default=101,
...
def predict_perturbation(
    ...
    model_name = 'scPILOT_w_o_adaptive_weighting',
    ...
    for ot_flag in [1]:
        ...
        if ot_flag == 0:
            ...
            print(
                'Ablation setting: use_adaptive_weighting=False',
                flush=True,
            )
        ...
        adata_query_eval_to_save.write_h5ad(
            f'../Result_anndata/{experiment_name}/'
            f'{experiment_name}_{eval_model_name}_{data_file}_{query_key}_seed{seed}{file_type}'
        )
