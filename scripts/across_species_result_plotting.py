...
def plot_result(
    ...
    r2mean_final_df['Cell label'] = r2mean_final_df['Cell label'].replace({
        'mouse': 'Mouse',
        'pig': 'Pig',
        'rabbit': 'Rabbit',
        'rat': 'Rat',
    ...
    l2mean_final_df['Cell label'] = l2mean_final_df['Cell label'].replace({
        'mouse': 'Mouse',
        'pig': 'Pig',
        'rabbit': 'Rabbit',
        'rat': 'Rat',
    ...
    r2var_final_df['Cell label'] = r2var_final_df['Cell label'].replace({
        'mouse': 'Mouse',
        'pig': 'Pig',
        'rabbit': 'Rabbit',
        'rat': 'Rat',
    ...
    l2var_final_df['Cell label'] = l2var_final_df['Cell label'].replace({
        'mouse': 'Mouse',
        'pig': 'Pig',
        'rabbit': 'Rabbit',
        'rat': 'Rat',
    ...
    mmd_final_df['Cell label'] = mmd_final_df['Cell label'].replace({
        'mouse': 'Mouse',
        'pig': 'Pig',
        'rabbit': 'Rabbit',
        'rat': 'Rat',
