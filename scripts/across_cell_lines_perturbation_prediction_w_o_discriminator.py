...
parser = argparse.ArgumentParser(description='across_cell_lines_perturbation_prediction_w_o_discriminator')
parser.add_argument(
    '--query_key',
    type = str,
    default = 'A549',
...
def predict_perturbation(
    ...
    # Outer hold-out setting is unchanged: only the stimulated cells of the query cell line are excluded.
