...
parser = argparse.ArgumentParser(description='across_patients_perturbation_prediction_w_o_Leiden')
parser.add_argument(
    '--query_key',
    type=int,
    default=101,
...
def predict_perturbation(
    ...
    for ot_flag in [1]:
        ...
        if ot_flag == 0:
            ...
            print(
                'Ablation setting: use_leiden=False',
                flush=True,
            )
