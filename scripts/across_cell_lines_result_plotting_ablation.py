...
def plot_shared_umaps_from_h5ad(
    ...
    output_name='across_cell_lines_ablation',
...
def paired_test_reference_vs_variant(
    ...
    Each paired observation is one held-out cell line.
    Values are first averaged across model seeds within each cell line.
    """
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description='Across-cell-line ablation result plotting and summary.'
    )
    ...
    parser.add_argument(
        '--output_name',
        type=str,
        default='across_cell_lines_ablation',
    )
